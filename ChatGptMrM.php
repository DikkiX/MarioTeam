...
$dbhost = isset($dbhost) ? (string) $dbhost : '';
$dbname = isset($dbname) ? (string) $dbname : '';
$dbuser = isset($dbuser) ? (string) $dbuser : '';
$dbpass = isset($dbpass) ? (string) $dbpass : '';
...
$mailadres = isset($mailadres) ? (string) $mailadres : '';
$headers = isset($headers) ? (string) $headers : '';
